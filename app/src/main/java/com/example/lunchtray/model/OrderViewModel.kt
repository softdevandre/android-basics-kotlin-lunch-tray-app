...
class OrderViewModel : ViewModel() {
    ...
    fun setEntree(entree: String) {
        ...
        //  entree price.
        if (_entree.value != null) previousEntreePrice = _entree.value!!.price
        ...
        if (_subtotal.value != null) _subtotal.value = previousEntreePrice - _subtotal.value!!
    ...
    fun setSide(side: String) {
        ...
        if (_side.value != null) previousSidePrice = _side.value!!.price
        ...
        if (_subtotal.value != null) _subtotal.value = previousSidePrice - _subtotal.value!!
    ...
    fun setAccompaniment(accompaniment: String) {
        ...
        if (_accompaniment.value != null) previousAccompanimentPrice = _accompaniment.value!!.price
        ...
        //  accompaniment.
        if (_accompaniment.value != null) _subtotal.value = previousAccompanimentPrice - _subtotal.value!!
